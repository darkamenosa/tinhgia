  ...
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var k,
          ...
          j = !!function() {
            try {
              ...
              return (m || "function" == typeof PromiseRejectionEvent) && a.then(l) instanceof c;
            } catch (e) {}
          }(),
          z = function(a, b) {
            return a === b || a === d && b === w;
                ...
                for (var d = a._v,
                    ...
                    g = function(b) {
                      var c,
                          ...
                          f = b.reject;
                      try {
                        g ? (e || (2 == a._h && H(a), a._h = 1), c = g === !0 ? d : g(d), c === b.promise ? f(t("Promise-chain cycle")) : (h = A(c)) ? h.call(c, i, f) : i(c)) : f(d);
                      } catch (j) {
                        f(j);
                      }
                    }; b.length > f; )
          ...
          F = function(b) {
            B.call(e, function() {
              var c,
                  ...
                  f = b._v;
              if (o(b) && (c = p(function() {
                m ? s.emit("unhandledRejection", f, b) : (g = e.onunhandledrejection) ? g({
                  promise: b,
                  reason: f
                }) : (d = e.console) && d.error && d.error("Unhandled promise rejection", f);
              }), b._h = m || o(b) ? 2 : 1), b._a = a, c)
                throw c.error;
            });
          },
          o = function(a) {
          ...
          H = function(a) {
            B.call(e, function() {
              var b;
              m ? s.emit("rejectionHandled", a) : (b = e.onrejectionhandled) && b({
                promise: a,
                reason: a._v
              });
            });
      ...
      j || (d = function Promise(a) {
        C(this, d, f, "_h"), n(a), k.call(this);
        try {
          a(h(r, this, 1), h(g, this, 1));
        } catch (b) {
          g.call(this, b);
        }
      }, k = function Promise(b) {
        this._c = [], this._a = a, this._s = 0, this._d = !1, this._v = a, this._h = 0, this._n = !1;
      }, k.prototype = b(185)(d.prototype, {
        then: function then(b, c) {
          var a = i(G(this, d));
          return a.ok = "function" == typeof b ? b : !0, a.fail = "function" == typeof c && c, this._c.push(a), this._a && this._a.push(a), this._s && q(this, !1), a.promise;
        },
        "catch": function(b) {
        ...
        var a = new k;
        this.promise = a, this.resolve = h(r, a, 1), this.reject = h(g, a, 1);
      }), c(c.G + c.W + c.F * !j, {Promise: d}), b(22)(d, f), b(179)(f), w = b(3)[f], c(c.S + c.F * !j, f, {reject: function reject(b) {
          var a = i(this),
              c = a.reject;
